...
class SPM_InnerRotorPMFieldProblem:
    ...
    def __init__(self, alpha_p, p, muR, Br, r_fe, dm, delta, mag_dir):
...
class SPM_InnerRotorPMFieldAnalyzer:
...
class SPM_InnerRotorPMField:
    ...
    def radial(self, alpha: np.array, r, theta, harmonics):
        ...
        b_radial_h = self.radial_harmonics(r, theta, harmonics)
        n = harmonics * self.p
        b_radial = self.__field_from_harmonics(b_radial_h, n, alpha)
        return b_radial

    def tan(self, alpha: np.array, r, theta, harmonics):
        ...
        b_tan_h = self.tan_harmonics(r, theta, harmonics)
        n = harmonics * self.p
        b_tan = self.__field_from_harmonics(b_tan_h, n, alpha)
        return b_tan

    def radial_harmonics(self, r, theta, harmonics):
    ...
    def tan_harmonics(self, r, theta, harmonics):
