...
from ..radial_machines import DPNVWinding, Stator, IM_Rotor_Round_Slots_Double_Cage, MPWinding, MachineComponent
from copy import deepcopy
import numpy as np

__all__ = ['BIM_Double_Cage_Machine']

class BIM_Double_Cage_Machine(Machine, IM_Rotor_Round_Slots_Double_Cage, Stator, MPWinding):
    ...
    def required_dimensions():
        req_dims = ("l_st",)
        for cl in BIM_Double_Cage_Machine.__bases__:
    ...
    def clone(self, **kwargs) -> "BIM_Double_Cage_Machine":
    ...
    @property
    def R_bar1_center(self):
        R_bar1_center = self.r_ri + self.d_ri + 2 * self.r_rb + self.d_rb + self.r_rb
        return R_bar1_center

    @property
    def R_bar2_center(self):
        R_bar2_center = self.r_ri + self.d_ri + self.r_rb
        return R_bar2_center
