# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 19:27:36 2021
...
JMAG_FEA_Configuration = {
    ...
    'number_of_steps_per_rev_1TS': 4, # Should be TSS actually... Also, number_of_steps_1stTTS is not implemented.
    'number_of_steps_per_rev_2TS': 16, # use a multiples of 4! # 8*32 # steps for half period (0.5). That is, we implement two time sections, the 1st section lasts half slip period and the 2nd section lasts half fandamental period.
