...
class CrossSectBreadloaf(CrossSectBase):
    ...
    def draw(self, drawer):
        ...
        # transform coords
        p1 = self.location.transform_coords(np.array([p1]))
        p2 = self.location.transform_coords(np.array([p2]))
        p3 = self.location.transform_coords(np.array([p3]))
        p4 = self.location.transform_coords(np.array([p4]))
        arcCenter = self.location.transform_coords(np.array([arc_center]))
